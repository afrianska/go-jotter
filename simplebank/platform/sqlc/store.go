...
func (store *Store) ExecTx(ctx context.Context, fn func(*Queries) error) error {
	...
	if err != nil {
		if rbErr := tx.Rollback(); rbErr != nil {
			return fmt.Errorf("tx err: %v, tx rb err: %v", err, rbErr)
		}
		return err
	}
...
// TransferTxParams containt the input paramenters of the tranfer transaction
...
// TranferTx performs a money transfer from one account to other.
